...
test('Compose exposes both protocol-specific API keys on the gateway service', async () => {
  ...
  for (const name of [
    ...
    'MANAGED_WEB_STREAM_PROGRESS_MODE',
    'MANAGED_WEB_STREAM_PROGRESS_DETAIL',
    'MANAGED_WEB_STREAM_PROGRESS_INTERVAL_MS',
    'MANAGED_WEB_STREAM_PROGRESS_MAX_LABEL_CHARS',
    'MANAGED_WEB_STREAM_PROGRESS_MAX_DOTS',
    'WEBSEARCH_MAX_PARALLEL',
    'WEBFETCH_MAX_PARALLEL',
    'VLLM_OPENAI_PROXY_API_KEY',
    'CLAUDE_CODE_TOOL_RECOVERY_ENABLED',
    'CLAUDE_CODE_ACTION_INTENT_GUARD_ENABLED',
    'CLAUDE_CODE_PLACEHOLDER_COMPLETION_GUARD_ENABLED',
    'CLAUDE_CODE_TOOL_INPUT_SCHEMA_GUARD_ENABLED',
