...
function emptySemanticMetrics() {
  return {
    ...
    responseTerminalEvent: null,
    responseStatus: null,
    responseIncompleteReason: null,
    responseIncompleteDetails: null,
    messageStopped: null,
    stopReason: null,
...
export async function performBufferedAttempt({
  ...
  const reportProgress = () => {
    ...
    observer.onProgress({
      ...
      responseIncomplete: semantic.responseIncomplete,
      responseCancelled: semantic.responseCancelled,
      responseFailed: semantic.responseFailed,
      responseTerminal: semantic.responseTerminal,
      responseTerminalEvent: semantic.responseTerminalEvent,
      responseStatus: semantic.responseStatus,
      responseIncompleteReason: semantic.responseIncompleteReason,
      responseIncompleteDetails: semantic.responseIncompleteDetails,
